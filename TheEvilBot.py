...
requests.post(
    f"https://api.telegram.org/bot{token}/sendMessage?chat_id={chat_id1}&text=Выбери команду: /ip, /spec, /screenshot, /webcam, /message, /input, /wallpaper, /off, /restart, /sleep, /request")
...
def start(message):
    ...
    btns = ['/ip', '/spec', '/screenshot', '/webcam',
            '/message', '/input', '/off', '/restart', '/sleep', '/request']
